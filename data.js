...
const ECLIPTICA_DATA = {
 ...
 "vrct_builds": [
  ...
  },
  {
   ...
   "patch": "v0.5 demo",
   "source": "VRCT 社区分享 · 折耳小花猫",
   "note": "不能吃奶要控血，被奶就会死哦，有名刀就不要点生命太高了，生命高了难触发。火和暗看着选择想玩火就玩火想玩暗就点暗。",
   "must": [
    {
     "id": "nk_proficiency",
     "count": 10,
   ...
   "nice": [],
   "avoid": [],
   "playstyle": "不能吃奶要控血，被奶就会死哦，有名刀就不要点生命太高了，生命高了难触发。火和暗看着选择想玩火就玩火想玩暗就点暗。",
   "reroll": "",
   "author": "折耳小花猫",
   "stats": "👍0 ⭐2 👁84 📋1",
  ...
  },
  {
   ...
   "note": "超权威的书奶大人，DPS220+，有生存有输出有回复有位移有支援，疑似最终答案 凤凰的下位替代为冰狮 奇术师：精通 带来的加成为曲线收益，实际建议点3~6个 额外点数可以优先给“奇术师：精通”“蓬松”“运动健将”“迅捷之手” 每五个鹰眼会抵消一个分裂弹（v0.51版本未测试） 符文建议：伤害增长、攻速增长、大之需要 诅咒避开：降低被回复量，弹道扩散  【腾讯文档】符文效果与等效token分析表 https://docs.qq.com/sheet/DZmNtbWJ6UXhmU3RB?tab=000001",
   "must": [
    {
     "id": "swift_hands",
     "count": 8,
   ...
   "nice": [],
   "avoid": [],
   "playstyle": "超权威的书奶大人，DPS220+，有生存有输出有回复有位移有支援，疑似最终答案 凤凰的下位替代为冰狮 奇术师：精通 带来的加成为曲线收益，实际建议点3~6个 额外点数可以优先给“奇术师：精通”“蓬松”“运动健将”“迅捷之手” 每五个鹰眼会抵消一个分裂弹（v0.51版本未测试） 符文建议：伤害增长、攻速增长、大之需要 诅咒避开：降低被回复量，弹道扩散  【腾讯文档】符文效果与等效token分析表 https://docs.qq.com/sheet/DZmNtbWJ6UXhmU3RB?tab=000001",
   "reroll": "",
  ...
  },
  {
   ...
   "patch": "v0.5 demo",
   "source": "VRCT 社区分享 · MRximxin11",
   "note": "原来光枪其实是坦克位 总是被手刀吓哭怎么办？ 我这里有更轮椅的打法 生命220 攻速 240 物理防御300+ 伤害随便吃 ，打的还没我回的快 没有数值，只有快乐",
   "must": [
    {
     "id": "vital_drain",
     "count": 11,
   ...
   "nice": [],
   "avoid": [],
   "playstyle": "原来光枪其实是坦克位 总是被手刀吓哭怎么办？ 我这里有更轮椅的打法 生命220 攻速 240 物理防御300+ 伤害随便吃 ，打的还没我回的快 没有数值，只有快乐",
   "reroll": "",
   "author": "MRximxin11",
   "stats": "👍0 ⭐10 👁75 📋4",
   "createdAt": "2026-07-26",
  ...
  {
   "archetypeId": "vrct_build-01a02000-8cc3-7536-8be8-6aece080b10b",
   "classId": "twinmage",
   "archetype": "野排生存风法-by老祖",
   "title": "野排生存风法-by老祖",
   "patch": "v0.5 demo",
   "source": "VRCT 社区分享 · 骨木-老祖",
   "note": "先不点暴击,三阶段还没有算盘再点",
   "must": [
    {
     "id": "swift_hands",
     "count": 10,
  ...
  },
  {
   ...
   "note": "无伤害容错极低，不适合新手使用 被Boss锁定阵亡概率大",
   "must": [
    {
     "id": "sticky",
     "count": 99,
   ...
   "nice": [],
   "avoid": [],
   "playstyle": "无伤害容错极低，不适合新手使用 被Boss锁定阵亡概率大",
   "reroll": "",
   "author": "BuGaoxing",
   "stats": "👍1 ⭐0 👁11 📋0",
